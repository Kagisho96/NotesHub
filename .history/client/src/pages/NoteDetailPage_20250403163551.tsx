      ...
      <div className={`${darkMode ? 'bg-gray-800 border border-gray-700' : 'bg-white'} rounded-lg shadow-md overflow-hidden`}>
          ...
          <div className="flex justify-between items-center">
            <div className="flex space-x-4">
              ...
              <button 
                ...
                className={`flex items-center space-x-1 px-3 py-1 rounded-md ${
                  currentNote.userReaction === 'dislike'
              ...
              >
                <FaThumbsDown />
                <span>{currentNote.dislikes}</span>
              </button>
            </div>
            ...
            >
              <FaComment />
              <span>{(currentNote?.comments?.length || 0)} Comments</span>
            </button>
          </div>
        </div>
        ...
        {showComments && (
          <div className={`px-6 py-4 ${darkMode ? 'border-t border-gray-700' : 'border-t border-gray-200'}`}>
            ...
            {/* Comments List */}
            {(currentNote?.comments?.length || 0) > 0 ? (
