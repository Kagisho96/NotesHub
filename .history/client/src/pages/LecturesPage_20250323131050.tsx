...
const LecturesPage = () => {
  const { lectures, fetchLectures, error } = useLecturesStore();
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className={`${darkMode ? 'text-gray-300' : 'text-gray-600'} text-sm mb-4 h-10 overflow-hidden`}>
                  {lecture.description?.substring(0, 80) || 'No description available'}
                  {lecture.description && lecture.description.length > 80 ? "..." : ""}
                </p>
